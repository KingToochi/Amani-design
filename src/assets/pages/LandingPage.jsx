...
const LandingImages = [trending, trending1, trending2, trending3, ,trending4, trending5, trending6, trending7, trending8, trending9, trending0, trending11]
            ...
            ">
                ...
                >
                    ...
                    >
                        <Link to="">
                            <span
                            className="text-center text-base font-semibold text-gray-100"
                ...
                <div 
                className="flex flex-col items-center gap-4 text-gray-100 w-full justify-center "
                >
                    <h2
                    className="text-base font-bold flex gap-4"
                    >Already a member? 
                    <button 
                    className="w-auto px-2  text-center text-base font-bold text-gray-100 rounded-lg cursor-pointer"
                    onClick={handleClick}
                    type="button">Log in</button></h2>
                     <h2
                     className="text-base font-bold flex gap-4"
                     >Are you a designer? <button 
                     className="w-auto px-2  text-base font-bold text-center text-gray-100 rounded-lg cursor-pointer"
                     type="button">Get started here!</button></h2>
                </div>
            </div>
            {displayShowModal()}
        </div>
